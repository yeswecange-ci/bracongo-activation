...
@if(!$isOnline)
<a href="{{ $waOnline }}" target="_blank"
   class="flex items-center gap-3 p-4 rounded-2xl mb-5 active:opacity-80 transition-opacity"
   style="background: linear-gradient(135deg, #1A1A1A 0%, #2A2A2A 100%)">
    ...
    <div class="flex-1 min-w-0">
        <p class="text-sm font-black text-white">Recevoir les commandes aujourd'hui</p>
        <p class="text-xs text-white/50 mt-0.5">Appuyez pour vous connecter · 1 fois par jour</p>
    </div>
...
@else
<div class="flex items-center justify-between p-4 rounded-2xl mb-5 bg-green-50 border border-green-200">
    <div>
    ...
    <a href="{{ $waOffline }}" target="_blank"
