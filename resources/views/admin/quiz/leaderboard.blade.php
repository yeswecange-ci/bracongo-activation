...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between bg-white rounded-xl shadow-sm p-6">
        ...
        <div class="relative inline-block text-left" x-data="{ open: false }">
            <button @click="open = !open" type="button" class="inline-flex items-center bg-gradient-to-r from-green-600 to-green-700 text-white px-6 py-3 rounded-lg hover:from-green-700 hover:to-green-800 transition-all shadow-md hover:shadow-lg">
            ...
            <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-10">
                <div class="py-2">
                    <a href="{{ route('admin.quiz.export', ['type' => 'leaderboard']) }}" class="flex items-center px-4 py-3 hover:bg-gray-50 transition">
                        <svg class="w-5 h-5 mr-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                        </svg>
                        <div>
                            <div class="text-sm font-semibold text-gray-900">Classement complet</div>
                            <div class="text-xs text-gray-500">Tous les joueurs</div>
                        </div>
                    </a>
                    ...
                    <div class="px-4 py-2">
                        <div class="text-xs font-semibold text-gray-500 uppercase">Gagnants (Top N)</div>
                    </div>

                    <a href="{{ route('admin.quiz.export', ['type' => 'winners', 'limit' => 10]) }}" class="flex items-center px-4 py-3 hover:bg-gray-50 transition">
                        <svg class="w-5 h-5 mr-3 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path>
                        </svg>
                        <div>
                            <div class="text-sm font-semibold text-gray-900">Top 10</div>
                            <div class="text-xs text-gray-500">Les 10 meilleurs</div>
                        </div>
                    </a>

                    <a href="{{ route('admin.quiz.export', ['type' => 'winners', 'limit' => 20]) }}" class="flex items-center px-4 py-3 hover:bg-gray-50 transition">
                        <svg class="w-5 h-5 mr-3 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                        </svg>
                        <div>
                            <div class="text-sm font-semibold text-gray-900">Top 20</div>
                            <div class="text-xs text-gray-500">Les 20 meilleurs</div>
                        </div>
                    </a>

                    <a href="{{ route('admin.quiz.export', ['type' => 'winners', 'limit' => 50]) }}" class="flex items-center px-4 py-3 hover:bg-gray-50 transition">
                        ...
                        <div>
                            <div class="text-sm font-semibold text-gray-900">Top 50</div>
                            <div class="text-xs text-gray-500">Les 50 meilleurs</div>
                        </div>
                    </a>

                    <a href="{{ route('admin.quiz.export', ['type' => 'winners', 'limit' => 100]) }}" class="flex items-center px-4 py-3 hover:bg-gray-50 transition">
                        <svg class="w-5 h-5 mr-3 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                        </svg>
                        <div>
                            <div class="text-sm font-semibold text-gray-900">Top 100</div>
                            <div class="text-xs text-gray-500">Les 100 meilleurs</div>
                        </div>
                    </a>
                </div>
            </div>
