...
<div class="space-y-6">
    ...
    <div class="flex justify-end">
        <a href="{{ route('admin.dashboard.export.detailed-stats') }}"
           class="inline-flex items-center bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 py-3 rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all shadow-md hover:shadow-lg font-semibold">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
            </svg>
            Exporter Statistiques Détaillées (CSV)
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Total Inscrits -->
        <div class="relative bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl shadow-lg p-6 text-white overflow-hidden">
            ...
            <div class="relative">
                ...
                <p class="text-blue-100 text-sm font-medium mb-1">Total Inscrits</p>
                <h3 class="text-4xl font-bold mb-2">{{ number_format($totalUsers) }}</h3>
                <p class="text-blue-100 text-sm flex items-center">
                    @if($userGrowthPercent >= 0)
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                        </svg>
                        +{{ $userGrowthPercent }}% cette semaine
                    @else
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Villages CAN -->
        <div class="relative bg-gradient-to-br from-green-500 to-green-700 rounded-xl shadow-lg p-6 text-white overflow-hidden">
            <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full"></div>
            <div class="absolute bottom-0 left-0 -mb-8 -ml-8 w-32 h-32 bg-white opacity-10 rounded-full"></div>
            <div class="relative">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-green-100 text-sm font-medium mb-1">Villages CAN</p>
                <h3 class="text-4xl font-bold mb-2">{{ $totalVillages }}</h3>
                <p class="text-green-100 text-sm">Villages actifs</p>
            </div>
        </div>

        <!-- Pronostics Actifs -->
        <div class="relative bg-gradient-to-br from-yellow-500 to-yellow-700 rounded-xl shadow-lg p-6 text-white overflow-hidden">
            <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full"></div>
            <div class="absolute bottom-0 left-0 -mb-8 -ml-8 w-32 h-32 bg-white opacity-10 rounded-full"></div>
            <div class="relative">
                <div class="flex items-center justify-between mb-4">
        ...
        <!-- Messages Envoyés -->
        <div class="relative bg-gradient-to-br from-purple-500 to-purple-700 rounded-xl shadow-lg p-6 text-white overflow-hidden">
            <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full"></div>
            <div class="absolute bottom-0 left-0 -mb-8 -ml-8 w-32 h-32 bg-white opacity-10 rounded-full"></div>
            <div class="relative">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-purple-100 text-sm font-medium mb-1">Messages Envoyés</p>
                <h3 class="text-4xl font-bold mb-2">{{ number_format($totalMessages) }}</h3>
                <p class="text-purple-100 text-sm">Via WhatsApp ({{ $deliveryRate }}% délivrés)</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
            <div class="flex items-center mb-4">
                ...
                <h2 class="text-lg font-bold text-gray-900">Évolution des Inscriptions (7 derniers jours)</h2>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
            <div class="flex items-center mb-4">
                ...
                <h2 class="text-lg font-bold text-gray-900">Répartition par Source</h2>
            </div>
            <div style="height: 280px;">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
            <div class="flex items-center mb-4">
                ...
                <h2 class="text-lg font-bold text-gray-900">Top 5 Villages</h2>
            </div>
            <div style="height: 280px;">
