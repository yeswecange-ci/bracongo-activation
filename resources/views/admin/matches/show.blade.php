        ...
        <div class="flex items-center justify-between mb-4">
            ...
            @if($match->pronostics->count() > 0)
                ...
                <div class="flex items-center space-x-3">
                    ...
                    @if($winnersCount > 0)
                        <a href="{{ route('admin.pronostics.export.match-winners-pdf', $match) }}"
                           class="inline-flex items-center px-4 py-2 bg-red-600 text-white text-sm font-semibold rounded-lg hover:bg-red-700 transition shadow-sm">
