...
@section('title', 'LCK — Nouveau compte')
@section('page-title', 'Nouveau compte commercante')
...
<div class="space-y-6 max-w-xl">
    ...
    <div class="flex items-center gap-2 text-sm">
        ...
        <span class="text-gray-600">Nouveau compte</span>
    </div>
    ...
    <form method="POST" action="{{ route('admin.lck.commercants.store') }}"
        ...
        <div class="p-6 space-y-5">
            ...
            <div>
                ...
                <input type="text" name="phone" value="{{ old('phone') }}" placeholder="+243..."
                       class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent">
            </div>
            ...
            <div>
                ...
                <select name="role" required class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent bg-white">
                    <option value="commercial" {{ old('role') === 'commercial' ? 'selected' : '' }}>Commercial(e) — gestion des commandes uniquement</option>
                    <option value="caviste" {{ old('role') === 'caviste' ? 'selected' : '' }}>Caviste — commandes + gestion du catalogue</option>
                </select>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Confirmation *</label>
